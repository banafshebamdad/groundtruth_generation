...
def main():
    ...
    # get the dataset name and configuration type from cmd line params.
    if len(sys.argv) > 2:
    ...
    CAM0_PATH = os.path.join(DIR_PATH, 'infra1', 'data')
    CAM1_PATH = os.path.join(DIR_PATH, 'infra2', 'data')
    run_bash_cmd("mkdir -p " + DIR_PATH + "/infra1/data")
    run_bash_cmd("mkdir -p " + DIR_PATH + "/infra2/data")

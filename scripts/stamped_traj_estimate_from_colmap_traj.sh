...
while read -r line1 && read -r line2; do
   ...
   # Internal Field Separator: a variable containing separator in $line1
   ...
   # Extract the frame ID. This Id will be used as a timestamp.
   timestamp="${NAME/.jpg/}"
 
   output_line="$timestamp $TX $TY $TZ $QX $QY $QZ $QW"

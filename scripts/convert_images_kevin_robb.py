...
#
# https://github.com/kevin-robb/orb_slam_implementation/blob/main/scripts/convert_images.py
#
# Modified by Banafshe Bamdad
# Mo Jul 31, 2023 11:49:40 CET
#
# Usage: $ python3 convert_images_kevin_robb.py [dataset_name] [cam_options] 
# cam_options: realsense_infra , realsense_color
# extracted images will be stored in ~/[dataset_name]
# 
import rospy
...
def main():
    ...
    # Commented by Banafshe Bamdad
    # cam_options = {"realsense" : ("/camera/color/image_raw", "/NONE"), "nuance": ("/camera_array/cam0/image_raw", "/camera_array/cam1/image_raw")}
    
    # Added by Banafshe Bamdad
    cam_options = {"realsense_color" : ("/camera/color/image_raw", "/NONE"), "realsense_infra" : ("/camera/infra1/image_rect_raw", "/camera/infra2/image_rect_raw")}
    ...
    CAM1_PATH = os.path.join(DIR_PATH, 'images', 'mav0', 'cam1', 'data') # B.B I change cam0 in this command to cam1
    ...
    # B.B in the following command, Image is the message type that the subscriber expects to receive on the cam_options[CAM_TYPE][0] topic
